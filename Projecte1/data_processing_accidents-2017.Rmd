...
##load files
```{r}
accidents <- read.csv("2017-data/2017_accidents_gu_bcn.csv")

persones <- read.csv("2017-data/2017_accidents_persones_gu_bcn.csv")
```
...
write.csv(merged_data, "2017-data/merged_data.csv", row.names = FALSE)
...
#Get the csv
write.csv(missing_data_summary, "2017-data/missing_data_summary.csv", row.names = FALSE)
