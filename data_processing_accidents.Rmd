...
```{r}
# Canviar la variable edad a numerica
merged_data$edat <- as.numeric(merged_data$Edat)
merged_data$edat[merged_data$edat == "Desconegut"] <- -1
...
columns_to_remove <- c("Num_postal_caption", "NK_.Any", "Mes_.any", "NK_Any", "edat")
...
new_column_names <- c("nExp", "cDis", "nDis", "cBar", "nBar", "cCar", "nCar", "dSet", "nMes", "mes", "dia", "hora", "torn", "causa", "morts", "lesLl", "lesGr", "vict", "vehi", "UTMX", "UTMY", "long", "lat", "nPos", "dTVehImp", "sexe", "edat", "dTPers", "dLlAtrVia", "dMotDesVia", "dMotDespCon", "dVict", "accbici")
